...
if(isset($_POST['delete_all'])){
   ...
   echo '<script>alert("Xóa tất cả");</script>';   
}
						...
						<table class="cart-table">
                            ...
                            ?>
								<tr class="table-body-row">
									<td class="product-remove"><a><i name="delete" onclick="return confirm(Xóa khóa học?');" class="far fa-window-close"></i></a></td>
									<td class="product-image"><img style="max-width: 170px; height:150px;"  src="uploaded_img/<?= $fetch_cart['image']; ?>" alt=""></td>
