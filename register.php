...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Đăng kí ngay</h3>
      <input type="text" name="name" required placeholder="Nhập tên tài khoản" class="box" maxlength="50">
      ...
      <input type="text" name="number" required placeholder="Nhập số điện thoại" class="box" min="0" max="9999999999" maxlength="10">
      <input type="text" name="address" required placeholder="Nhập địa chỉ" class="box" maxlength="50">
