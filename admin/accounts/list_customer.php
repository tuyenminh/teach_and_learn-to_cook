              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    $select_account = $conn->prepare("SELECT * FROM `users` LIMIT :offset, :rows_per_page");
                                ...
                                <td class="form-group">
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item">
                                            <a href="update_customer.php?update_customer=<?= $fetch_admin['id']; ?>"><button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i> </button></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="list_customer.php?delete=<?= $fetch_admin['id']; ?>" type="button" onclick="return confirm('Xóa tài khoản');"><button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button></a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                    ...
                    $total_rows = $conn->query("SELECT count(*) FROM `users`")->fetchColumn();
                    $total_pages = ceil($total_rows / $rows_per_page);

                    $list_page = "";

                    for ($i = 1; $i <= $total_pages; $i++) {
                        $list_page .= '<li class="page-item"><a class="page-link" href="http://localhost/teach_and_learn-to_cook/admin/accounts/list_customer.php?page=' . $i . '">' . $i . '</a></li>';
                    }
                    ?>
