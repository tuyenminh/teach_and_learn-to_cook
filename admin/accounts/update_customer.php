...
if(!isset($admin_id)){
   ...
   $update_users = $conn->prepare("UPDATE `users` SET name = ?, email = ?, number = ?, password = ?, address = ?, admin_id = ? WHERE id = ?");
   $update_users->execute([$name, $email, $number,  $password, $address, $admin_id, $uid]);
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php
                $update_id = $_GET['update_customer'];
            ...
            ?>
              ...
              <input type="hidden" name="uid" value="<?= $fetch_accounts['id']; ?>">
                ...
                <div class="card-footer">
                  ...
                  <a href="list_customer.php" class="btn btn-primary">Trở về</a>
